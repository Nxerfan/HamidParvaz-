document.addEventListener("DOMContentLoaded", function () {
  ...
  setupDropdown("filterBtn", "filterContent");
  setupDropdown("HotelStarBtn", "HotelStarContent");
  setupDropdown("classBtn", "classContent");
  setupDropdown("timeBtn", "timeContent");
  setupDropdown("airlineBtn", "airlineContent");
  setupDropdown("baggageBtn", "baggageContent");
  setupDropdown("tagsBtn", "tagsContent");
